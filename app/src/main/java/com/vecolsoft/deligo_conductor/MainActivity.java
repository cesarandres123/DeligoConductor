...
import com.vecolsoft.deligo_conductor.Modelo.User;
...
public class MainActivity extends AppCompatActivity {
    ...
    RelativeLayout rootLayout, rellay1, rellay2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler.postDelayed(runnable, 2000); //2000 = 2 Sec. para el splahs
    ...
    private void Ingresar() {
        ...
        EditText edtEmail = rootLayout.findViewById(R.id.edtEmail);
        EditText edtPassword = rootLayout.findViewById(R.id.edtPassword);
                ...
                auth.createUserWithEmailAndPassword(edtEmailR.getText().toString(), edtPasswordR.getText().toString())
                        .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                            ...
                            public void onSuccess(AuthResult authResult) {
                                ...
                                //usar el email como clave *user.getEmail()* posible uso de nombre.
